...
app.get('/searchProjects/:searchString', db.searchProjects)
...
app.post('/editProject', db.editProject)
...
app.delete('/comment/:commentor/:timestamp', db.deleteComment)
app.delete('/follow/:follower/:creator/:orgname/:teamname/:projname', db.unfollowProject)
app.delete('/project/:username/:orgname/:teamname/:projname', db.deleteProject)
